...
function o1({
  ...
  return pl.useEffect(() => {
    ...
    try {
      ...
      const m = (r == null ? void 0 : r.sort((d, v) => ((d == null ? void 0 : d.price) || 0) - (v.price || 0)))[0];
      if (typeof (e == null ? void 0 : e.propertyNameKor) != "string" && typeof (e == null ? void 0 : e.propertyNameEng) != "string" || typeof m.price != "number" || typeof m.roomDescription != "string" || typeof m.cancelDeadLine != "string" || !/^\d{8}$/.test(m.cancelDeadLine))
        throw new Error("invalid room description data");
      y({
        hotelName: e.propertyNameKor || e.propertyNameEng,
        ...m,
        cancelDeadLine: m.cancelDeadLine.replace(/^(\d{4})(\d{2})(\d{2})$/, "$1-$2-$3")
      });
    } catch {
      y("카카오톡 상담 필요");
    }
