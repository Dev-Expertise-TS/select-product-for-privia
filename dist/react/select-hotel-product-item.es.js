...
function SelectHotelProductItem({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border-2 border-[#e5398f] overflow-hidden bg-white shadow-md md:shadow-none rounded-xl", children: [
    /* @__PURE__ */ jsx("header", { className: "bg-[#e5398f] text-white p-3 text-center sm:text-left font-medium", children: "럭셔리 셀렉트 - 후불 현장 결제" }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 lg:gap-0 items-start justify-stretch", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-3 p-4 sm:p-6 lg:p-8 lg:pr-4 px-0 py-0", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 md:gap-6 items-start", children: /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2 flex flex-col gap-3 p-4 md:p-0", children: [
        /* @__PURE__ */ jsx("span", { className: "font-semibold text-blue-600", children: "[후불 현장 결제]" }),
        isLoading || !firstRoom ? /* @__PURE__ */ jsx("div", { className: "w-48 h-6 animate-pulse bg-gray-200 rounded-sm" }) : typeof firstRoom !== "string" && /* @__PURE__ */ jsx("span", { className: "font-bold", children: firstRoom.hotelName }),
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "pt-3 mt-1", children: /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: [
          ...
          {
            icon: /* @__PURE__ */ jsx(CreditCard, { className: "w-4 h-4 text-gray-500" }),
            benefit: "$100 크레딧 제공"
          },
          {
            icon: /* @__PURE__ */ jsx(CircleArrowUp, { className: "w-4 h-4 text-gray-500" }),
            benefit: "객실 무료 업그레이드 (현장 가능시)"
          },
          {
            icon: /* @__PURE__ */ jsx(Clock, { className: "w-4 h-4 text-gray-500" }),
          ...
          "li",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { children: item.benefit })
            ]
          },
          index
        )) }) })
      ] }) }) }),
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 p-4 sm:p-6 lg:p-8 lg:border-l lg:border-dashed lg:border-gray-300 flex flex-col justify-between h-full lg:pl-12 border-t border-dashed", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-row sm:justify-between sm:items-end mb-4 w-full gap-2 justify-between items-end", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-500", children: "객실 요금" }),
          /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-gray-500 text-base hidden sm:block text-left", children: [
              nights,
              "박 예상결제가"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "font-bold text-gray-800 text-2xl", children: isLoading || !firstRoom ? /* @__PURE__ */ jsx("div", { className: "w-40 h-8 animate-pulse bg-gray-200 rounded-sm" }) : typeof firstRoom === "string" ? firstRoom : `${firstRoom.price.toLocaleString("ko-KR")}원 ~` })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "w-full text-right space-y-4 mt-auto", children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs text-red-500 text-left sm:text-right", children: /* @__PURE__ */ jsx("div", { children: "※ 현장 결제시 환율에 따라 최종 원화 결제 금액이 변동될 수 있습니다." }) }),
          /* @__PURE__ */ jsx(
            "a",
            {
...
//# sourceMappingURL=select-hotel-product-item.es.js.map
