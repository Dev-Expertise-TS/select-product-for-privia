...
function SelectHotelProductItem({
  ...
  const [fifthRoom, setFifthRoom] = useState();
  useEffect(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 lg:gap-0 items-start justify-stretch", children: [
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-3 p-4 sm:p-6 lg:p-8 lg:pr-4 px-0 py-0", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 md:gap-6 items-start", children: /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2 flex flex-col gap-3 p-4 md:p-0", children: [
            ...
            isLoading || !fifthRoom ? /* @__PURE__ */ jsx("div", { className: "w-48 h-6 animate-pulse bg-gray-200 rounded-sm" }) : typeof fifthRoom !== "string" && /* @__PURE__ */ jsx("span", { className: "font-bold", children: fifthRoom.hotelName }),
            /* @__PURE__ */ jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 p-4 sm:p-6 lg:p-8 lg:border-l lg:border-dashed lg:border-gray-300 flex flex-col justify-between h-full lg:pl-12 border-t border-dashed lg:border-t-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-row sm:justify-between sm:items-end mb-4 w-full gap-2 justify-between items-end", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-gray-500 hidden sm:block text-left", children: [
                  nights,
                  "박 예상결제가"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "font-bold text-gray-800 text-2xl", children: isLoading || !fifthRoom ? /* @__PURE__ */ jsx("div", { className: "w-40 h-8 animate-pulse bg-gray-200 rounded-sm" }) : typeof fifthRoom === "string" ? fifthRoom : `${fifthRoom.price.toLocaleString("ko-KR")}원 ~` })
              ] })
            ] }),
