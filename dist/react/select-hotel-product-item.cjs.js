          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "lg:col-span-3 p-4 sm:p-6 lg:p-8 lg:pr-4 px-0 py-0", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 md:gap-6 items-start", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sm:col-span-2 flex flex-col gap-3 p-4 md:p-0", children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                children: isLoading || !firstRoom ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-60 h-5 animate-pulse bg-gray-200 rounded-sm" }) : typeof firstRoom !== "string" && typeof firstRoom.cancelDeadLine === "string" && /^\d{4}-\d{2}-\d{2}$/.test(firstRoom.cancelDeadLine) && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "flex flex-col gap-1", children: [
              {
